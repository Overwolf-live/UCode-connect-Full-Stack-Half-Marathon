...
class Superhero extends Human{
    fly() {
        ...
        setTimeout(()=> {
            document.querySelector('#info').innerHTML = "Spider-man!";
...
function hero() {
    if(human.hero === false) {
        ...
        document.querySelector('img').src = 'assets/images/human.gif';
        document.querySelector('#hero').innerText = 'Spider-man!';
        document.querySelector('#fly').disabled = true;
        document.querySelector('#fight').disabled = true;
...
function fly() {
    ...
    setTimeout(() => {
        document.querySelector('img').src = 'assets/images/dancing.gif'
        document.querySelector('#info').innerHTML = "Spider-mans!"
        enableButtons();
    },10000);
...
function setFirstName(name) {
    ...
    if(name === undefined) {
        while(firstName.innerText === "" || firstName.innerText === null) {
            firstName.innerText = prompt("What's the FIRST name of your hero?", "Peter");
...
function setLastName(name) {
    ...
    if(name === undefined) {
        while(lastName.innerText === "" || lastName.innerText === null) {
            lastName.innerText = prompt("What's the LAST name of your hero?", "Parker");
            let regex = RegExp('^[a-zA-Z]+$');
...
function setAge() {
    ...
    while(age.innerText === "" || age.innerText === null) {
        age.innerText = prompt("What's the age of your hero?", "15");
